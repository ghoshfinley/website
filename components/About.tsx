export default function About() {
  return (
    <section id="about" className="py-24 px-10 md:px-20">
      <p className="text-md font-semibold tracking-widest text-cyan-400 uppercase mb-8">
        About Me
      </p>
      <div className="space-y-5 text-gray-300 text-lg leading-relaxed max-w-2xl">
        <p>
          ...
          code. The hard part is knowing what to build and why.
        </p>
        <p>
